  ...
  $("body").css("pointer-events", "auto");
     ...
     if (seq == tot) {
            $(".Qloader").show();
                ...
                xhttp.open("GET", "https://foonsci.github.io/s1s/result?qn=" + tot + res, true);
                xhttp.send();
                             var xhttp2 = new XMLHttpRequest();   
                            xhttp2.open("GET", "https://foonsci.github.io/s1s/data?qn=" + tot + res , true);
                            xhttp2.send();
